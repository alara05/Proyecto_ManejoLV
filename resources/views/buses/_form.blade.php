...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <div>
        <label for="numero" class="block text-sm font-semibold text-slate-700">Numero de bus</label>
    ...
    <div>
        <label for="placa" class="block text-sm font-semibold text-slate-700">Placa</label>
    ...
    <div>
        <label for="capacidad_total" class="block text-sm font-semibold text-slate-700">Capacidad total</label>
    ...
    <div>
        <label for="marca_chasis" class="block text-sm font-semibold text-slate-700">Marca del chasis</label>
    ...
    <div>
        <label for="marca_carroceria" class="block text-sm font-semibold text-slate-700">Marca de carroceria</label>
    ...
    <div>
        <label for="anio" class="block text-sm font-semibold text-slate-700">Anio</label>
    ...
    <div>
        <label for="foto_path" class="block text-sm font-semibold text-slate-700">Ruta de fotografia</label>
