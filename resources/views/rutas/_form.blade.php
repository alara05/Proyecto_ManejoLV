...
<div class="grid gap-5 md:grid-cols-2">
    ...
    <div>
        <label for="bus_id" class="block text-sm font-medium">Bus asignado</label>
    ...
    <div>
        <label for="ciudad_origen_id" class="block text-sm font-medium">Ciudad origen</label>
    ...
    <div>
        <label for="ciudad_destino_id" class="block text-sm font-medium">Ciudad destino</label>
    ...
    <div>
        <label for="nombre" class="block text-sm font-medium">Nombre de la ruta</label>
    ...
    <div>
        <label for="tipo_viaje" class="block text-sm font-medium">Tipo de viaje</label>
    ...
    <div>
        <label for="distancia_km" class="block text-sm font-medium">Distancia KM</label>
    ...
    <div>
        <label for="duracion_minutos" class="block text-sm font-medium">Duracion estimada en minutos</label>
